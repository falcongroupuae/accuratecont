(function ($) {
  ...
  if ($(".sidenav-bar, .hidden-bar").length) {
    ...
    //Dropdown Button
    $(".sidenav-bar .side-nav .navigation li.dropdown > a").on(
      "click",
      function () {
    ...
    //Dropdown Button
    $(".sidenav-bar .cross-icon, .hidden-bar .cross-icon, .form-back-drop").on(
      "click",
      function (e) {
        e.preventDefault();
  ...
  if (
    $(".specialize-section-two .image-carousel").length &&
    $(".specialize-section-two .thumbs-carousel").length
  ) {
